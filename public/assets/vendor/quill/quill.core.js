    ...
    return (function () {
        var t = {
                ...
                6142: function (t, e, n) {
                    ...
                    function m(t, e, n) {
                        ...
                        if ("html" in t && "function" == typeof t.html)
                            return t.html(e, n);
                        if (t instanceof f.A)
                            return (0, f.X)(t.value().slice(e, e + n));
                        ...
                        j = class {
                            ...
                            handleCompositionStart(t) {
                                ...
                                !e ||
                                    e instanceof O.A ||
                                    (this.emitter.emit(
                                        E.A.events.COMPOSITION_BEFORE_START,
                                        t
                                    ),
                                    this.scroll.batchStart(),
                                    this.emitter.emit(
                                        E.A.events.COMPOSITION_START,
                                        t
                                    ),
                                    (this.isComposing = !0));
                            }
                            handleCompositionEnd(t) {
                                this.emitter.emit(
                                    E.A.events.COMPOSITION_BEFORE_END,
                                    t
                                ),
                                    this.scroll.batchEnd(),
                                    this.emitter.emit(
                                        E.A.events.COMPOSITION_END,
                                        t
                                    ),
                                    (this.isComposing = !1);
                            }
                    ...
                    class q {
                        ...
                        constructor(t) {
                            ...
                            if (
                                ...
                                (this.selection = new d.A(
                                    this.scroll,
                                    this.emitter
                                )),
                                (this.composition = new j(
                                    this.scroll,
                                    this.emitter
                                )),
                                ...
                                this.emitter.on(
                                    E.A.events.SCROLL_EMBED_UPDATE,
                                    (t, e) => {
                                        const n = this.selection.lastRange,
                                            [r] = this.selection.getRange(),
                                            i =
                        ...
                        setSelection(t, e, n) {
                            null == t
                                ...
                                : (([t, e, , n] = P(t, e, n)),
                                  this.selection.setRange(
                                      new d.Q(Math.max(0, t), e),
                                      n
                                  ),
                                  n !== E.A.sources.SILENT &&
                                      this.scrollSelectionIntoView());
                        }
                        setText(t) {
                            let e =
                ...
                9541: function (t, e, n) {
                    ...
                    const s = new i.a2("background", "background-color", {
                        scope: r.Scope.INLINE,
                    });
                },
                9404: function (t, e, n) {
                ...
                8638: function (t, e, n) {
                    ...
                    new r.ClassAttributor("color", "ql-color", {
                        scope: r.Scope.INLINE,
                    });
                    const s = new i("color", "color", {
                        scope: r.Scope.INLINE,
                    });
                },
                7912: function (t, e, n) {
                ...
                584: function (t, e, n) {
                    ...
                    const w = (0, l.A)("quill:clipboard"),
                        ...
                        S = [u.Hu, h.s, d.JM, p.VL, g.z, m.r].reduce(
                            (t, e) => ((t[e.keyName] = e), t),
                            {}
                        );
                    class L extends a.A {
                        ...
                        constructor(t, e) {
                            super(t, e),
                                ...
                                (this.matchers = []),
                                O.concat(this.options.matchers ?? []).forEach(
                                    (t) => {
                                        let [e, n] = t;
                                        this.addMatcher(e, n);
                                    }
                ...
                8123: function (t, e, n) {
                    ...
                    const h = (0, c.A)("quill:keyboard"),
                        f = /Mac/i.test(navigator.platform)
                            ? "metaKey"
                            : "ctrlKey";
                    class d extends u.A {
                        static match(t, e) {
                ...
                9629: function (t, e, n) {
                    ...
                    function Ct(t, e, n, r, i, d, y) {
                        var k;
                        if ((r && (k = d ? r(t, i, d, y) : r(t)), void 0 !== k))
                            return k;
                        if (!Wt(t)) return t;
                        var C = $t(t);
                        if (C) {
                    ...
                    function Pt(t) {
                        ...
                        return (
                            t === (("function" == typeof e && e.prototype) || Q)
                        );
                    }
                    function zt(t) {
                        if (null != t) {
                ...
                6003: function (t, e, n) {
                    ...
                    const A = v,
                        N = class t extends A {
                            ...
                            constructor(t, e) {
                                super(t, e),
                                    (this.attributes = new f(this.domNode));
                            }
                            format(e, n) {
            ...
            (function () {
                ...
                class g extends c.ScrollBlot {
                    ...
                    deleteAt(t, n) {
                        ...
                        if (
                            ...
                            if (r instanceof e.zo || o instanceof e.zo)
                                return void this.optimize();
                            const t =
                                o.children.head instanceof i.A
                                    ? null
                                    : o.children.head;
                    ...
                    insertContents(t, n) {
                        ...
                        r.length &&
                            ...
                            "block" === i.type &&
                                ...
                                m(
                                    this,
                                    o ? o.offset(o.scroll) + l : this.length(),
                                    i.delta
                                ),
                            this.batchEnd(),
                            this.optimize();
                ...
                class N extends A.A {
                    ...
                    constructor(e, n) {
                        super(e, n),
                            this.quill.on(
                                t.Ay.events.EDITOR_CHANGE,
                                (e, n, r, i) => {
                                    e === t.Ay.events.SELECTION_CHANGE
                                        ? n &&
                                          i !== t.Ay.sources.SILENT &&
                                          (this.currentRange = n)
                    ...
                    restoreSelection(e) {
                        if (e.range)
                            this.quill.setSelection(e.range, t.Ay.sources.USER);
                        else {
                    ...
                    constructor(e, n) {
                        super(e, n),
                            ...
                            /Android/i.test(navigator.userAgent) ||
                                e.on(
                                    t.Ay.events.COMPOSITION_BEFORE_START,
                                    () => {
                    ...
                    handleArrowKeys() {
                        this.quill.keyboard.addBinding({
                            ...
                            handler(e, n) {
                                ...
                                if (!(r instanceof c.ParentBlot && r.uiNode))
                                    return !0;
                                const s =
                                    "rtl" ===
                                    getComputedStyle(r.domNode).direction;
                                return (
                                    !!(
                                        (s && "ArrowRight" !== i.key) ||
                                        (!s && "ArrowLeft" !== i.key)
